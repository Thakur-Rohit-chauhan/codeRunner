...
export default function ProblemSolver() {
    ...
    // Only reset the editor when navigating to a different problem.
    // Metadata refreshes for the same problem (status, bookmark, lastSubmitted)
    // should not wipe the user's current draft.
    useEffect(() => {
    ...
    const handleRun = async () => {
        ...
        try {
            const result = await runProblem(problem.id, {
                ...
                language: lang,
                code: codes[lang] ?? getStarterCodeForLanguage(problem, lang),
                input: testInput,
            })
                            ...
                            <div style={{
                                ...
                                <div style={{ flex: 1 }}>
                                    <Editor
                                        ...
                                        value={codes[lang] ?? getStarterCodeForLanguage(problem, lang)}
