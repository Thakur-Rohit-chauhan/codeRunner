"""Submission SQLModel definition.

Represents user code submissions for evaluation by the judge service.
"""
...
class Submission(SQLModel, table=True):
    ...
    Tracks the full lifecycle from PENDING → QUEUED → RUNNING → COMPLETED/FAILED.
    """
    ...
    # Results (populated by judge-service)
